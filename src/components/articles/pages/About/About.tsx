...
const aboutDescription = (
  <>
    ...
    React. WebFace itself is also a study that I am working on continuously. It
    is getting updated regularly, and in the middle of it there might be bugs
    ...
    <br /> <br /> You can bookmark this page if this interests you! Navigate to
    the other tabs to read more. Thank you!
  </>
);
